...
<div id="content">
	...
	<div style="float: right; margin-bottom: 10px; margin-right: 25px;">
		<a href="add_salary.php"><button type="button">Add Employee Salary</button></a>
	</div>
			...
			<div id="table-content">
				...
				<!--  start product-table ..................................................................................... -->
                 <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
                   <tr>
					<th class="table-header-repeat" style="width: 80px;"><a href="">Emp ID</a>	</th>
					<th class="table-header-repeat line-left minwidth-1"><a href="">Emp Name</a></th>
					<th class="table-header-repeat line-left"><a href="">Email</a></th>
					<th class="table-header-repeat line-left"><a href="">Monthly Gross</a></th>
					<th class="table-header-repeat line-left"><a href="">Annual Gross</a></th>
					<th class="table-header-repeat line-left"><a href="">Monthly CTC</a></th>
					<th class="table-header-repeat line-left"><a href="">Annual CTC</a></th>
               ...
               $sql="SELECT * FROM emp_salary_list WHERE 1";
               ...
               ?>
                ...
                >
					...
					<td class="text-center"><?php echo $row['emp_email']; ?></a></td>
					<td class="text-center"><?php echo $row['monthly_gross']; ?></td>
					<td class="text-center"><?php echo $row['annual_gross']; ?></td>
                    <td class="text-center"><?php echo $row['monthly_total_ctc']; ?></td>
                    <td class="text-center"><?php echo $row['annual_total_ctc']; ?></td>
					...
					<a href="http://local.keshavatech-hr.com/sal_edit.php?atn=e&id=<?php echo $row['emp_no']; ?>" title="Edit" class="icon-1 info-tooltip"></a>
					<a href="http://www.keshavatech.com/hr-management/dashboard.php?atn=d&id=<?php echo $row['emp_no']; ?>" title="Delete" class="icon-2 info-tooltip"></a>
					<a href="http://www.keshavatech.com/hr-management/dashboard.php?atn=status&id=<?php echo $row['emp_no']; ?>" title="Status" class="icon-3 info-tooltip"></a>
					<a href="http://local.keshavatech-hr.com/sal_view.php?atn=v&id=<?php echo $row['emp_no']; ?>" title="View" class="icon-5 info-tooltip"></a>
