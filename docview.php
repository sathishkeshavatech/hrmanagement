...
<div class="nav-outer"> 
		...
		<ul class="select"><li><a href="http://www.keshavatech.com/hr-management/dashboard.php"><b>Dashboard</b><!--[if IE 7]><!--></a><!--<![endif]-->
...
<div id="page-heading">
  <h1>View Employee Documents </h1></div>
...
<iframe src="http://docs.google.com/viewer?url=http%3A%2F%2Fwww.keshavatech.com%2Fhr-management%2Fupload%2F<?php echo trim($dmt,"upload/"); ?>&embedded=true" width="800" height="780" style="border: none;"></iframe>
<?php
}
?>
	</td>
