...
<div class="nav-outer"> 
		...
		<ul class="current"><li><a href="http://localhost/keshava/admin/dashboard.php"><b>Dashboard</b><!--[if IE 7]><!--></a><!--<![endif]-->
		...
		<ul class="select">
		  <li><a href="http://localhost/keshava/admin/employee_details.php"><b>Add Employee Details</b><!--[if IE 7]><!--></a><!--<![endif]-->
		</li>
		</ul>
		<ul class="select">
		  <li><!--<![endif]-->
			...
			<div id="table-content">
				...
				<!--  start product-table ..................................................................................... -->
                 <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
                   <tr>
					...
					<th class="table-header-repeat line-left"><a href="">Documents</a></th>
               ...
               ?>
                ...
                >
					...
					<td><?php echo $row['emp_documents']; ?></td>
					...
					<a href="http://www.keshavatech.com/hr-management/dashboard.php?atn=d&id=15/dashboard.php?atn=d&id=<?php echo $row['id']; ?>" title="Delete" class="icon-2 info-tooltip"></a>
...
mysqli_close($con);
echo '<script type="text/javascript"> window.location.assign("http://localhost/keshava/admin/dashboard.php") </script>';
}
}
?>
			</div>
